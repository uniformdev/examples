 ...
 *     The delegation bootstrap calls `sdk.getSessionToken()`. This is a
 ...
 *
 *   Step 2 — THIS FILE (Express route, runs on your server):
 ...
 *     The browser only ever calls your own Express routes — it never has
...
export async function postApiSession(req, res) {
  ...
  try {
    ...
    // Seal the token pair into an encrypted JWE cookie (see cookieUtils.js for details).
