...
const Logo: React.FC<LogoProps> = ({ width, className }: LogoProps) => (
  <svg
    ...
    className={className}
  >
    <path d="M40.82 0L0 23.57v47.14l40.82-23.57 40.83-23.57z" fill="#83c6e1" />
    <path d="M40.82 94.28V47.14L0 70.71v47.14l40.82 23.57 40.83-23.57V70.71z" fill="#438fd5" />
    <path d="M81.65 23.57L40.82 47.14l40.83 23.57v47.14l40.82-23.57V47.14z" fill="#f4220b" />
    <path
