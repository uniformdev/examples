...
import { assignTrackingAttributes } from "@/lib/uniform/compositionUtil";
...
export const getServerSideProps = withUniformGetServerSideProps({
  ...
  handleComposition: async (
    ...
    // IMPORTANT: needed for tracking based on IntersectionObserver
    assignTrackingAttributes(composition);
