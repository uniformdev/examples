...
type SearchSortingProps = ComponentProps;

const SearchSorting: FC<SearchSortingProps> = () => {
  const { orderByOptions, selectedOrderBy, setOrderBy } = useSearch();
  ...
  return (
    ...
    >
      {orderByOptions.map(({ title, value }) => (
